...
metadata = a
protocol = simulate.get_protocol_api('2.1')
...
wash_reservoir = protocol.load_labware("nest_12_reservoir_15ml", 5)
plate_origin = protocol.load_labware("nest_96_wellplate_200ul_flat", 3)
plate_target = protocol.load_labware("nest_96_wellplate_200ul_flat", 6)
plate_dilution = protocol.load_labware("nest_96_wellplate_200ul_flat", 9)
...
protein_A = reagent_reservoir["A8"]
