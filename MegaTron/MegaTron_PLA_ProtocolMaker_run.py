...
MegaTron (Group 1) code for Proximity Ligation Assay. Will produce a 'Run' version of the protocol.
...
def MakeFile(file_name):
    with open(file_name, 'w') as f:
        f.write(f'''from opentrons import protocol_api
metadata = {a}
...
MakeFile("PLA_automation_protocol_run.py")
